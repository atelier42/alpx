            ...
            <?php if ('category' === $meta['type']) : ?>
                <span class="ce-product-meta__detail ce-product-meta__category">
                    <span class="ce-product-meta__label"><?=
                        $meta['label'] ?: "{Context::getContext()->getTranslator()->trans(
                        'Category: %category_name%', ['%category_name%' => ''], 'Shop.Theme.Catalog')|rtrim:': '}"
                    ?></span>
                    <a class="ce-product-meta__value" href="{url entity='category' id=$product.id_category_default}">
            ...
            <?php elseif ('manufacturer' === $meta['type']) : ?>
                {if $product.manufacturer_name}
                    <span class="ce-product-meta__detail ce-product-meta__manufacturer">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{l s='Brand' d='Shop.Theme.Catalog'}" ?></span>
                        <a class="ce-product-meta__value"
                            href="{Context::getContext()->link->getManufacturerLink($product.id_manufacturer)}">
            ...
            <?php elseif ('delivery' === $meta['type']) : ?>
                ...
                {if $delivery}
                    <span class="ce-product-meta__detail ce-product-meta__delivery">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{l s='Delivery Time' d='Admin.Catalog.Feature'}" ?></span>
            ...
            <?php elseif ('quantity' === $meta['type']) : ?>
                {if !empty($product.show_quantities)}
                    <span class="ce-product-meta__detail ce-product-meta__quantity">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{l s='In stock' d='Shop.Theme.Catalog'}" ?></span>
                        <span class="ce-product-meta__value">
                            {max(0, $product.quantity)|cat:" {$product.quantity_label}"}
                        </span>
                    </span>
                {/if}
            <?php elseif ('availability_date' === $meta['type']) : ?>
                {if !empty($product.availability_date)}
                    <span class="ce-product-meta__detail ce-product-meta__availability_date">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{Context::getContext()->getTranslator()->trans(
                                'Availability date:', [], 'Shop.Theme.Catalog')|rtrim:': '}" ?></span>
            ...
            <?php elseif ('condition' === $meta['type']) : ?>
                {if !empty($product.condition)}
                    <span class="ce-product-meta__detail ce-product-meta__condition">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{l s='Condition' d='Shop.Theme.Catalog'}" ?></span>
                        <span class="ce-product-meta__value">
            ...
            <?php elseif ('reference' === $meta['type']) : ?>
                {if $product.reference}
                    <span class="ce-product-meta__detail ce-product-meta__reference">
                        <span class="ce-product-meta__label"
                            ><?= $meta['label'] ?: "{l s='Reference' d='Shop.Theme.Catalog'}" ?></span>
                        <span class="ce-product-meta__value" itemprop="sku">{$product.reference}</span>
                    </span>
                {/if}
            <?php else : ?>
                ...
                {if !empty($product[$ref])}
                    <span class="ce-product-meta__detail ce-product-meta__{$ref}">
                        <span class="ce-product-meta__label">{$ref|upper}</span>
