            ...
            <?php if (!empty($group['attributes'])) : ?>
                ...
                <?php if ('select' === $group['group_type']) : ?>
                    <div class="ce-product-variants__select">
                        <select class="elementor-field elementor-field-textual elementor-size-<?= esc_attr($settings['select_size']) ?>"
                            form="add-to-cart-or-refresh" name="group[<?= (int) $id_attr_group ?>]" data-product-attribute="<?= (int) $id_attr_group ?>">
                ...
                <?php elseif ('radio' === $group['group_type']) : ?>
                    ...
                    <?php foreach ($group['attributes'] as $id_attr => $group_attr) : ?>
                        <label class="ce-product-variants__radio-wrapper" aria-label="<?= esc_attr($group_attr['name']) ?>">
                            <input class="ce-product-variants__radio" form="add-to-cart-or-refresh" type="radio" <?= $group_attr['selected'] ? 'checked' : '' ?>
