    ...
    protected function _registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'description' => sprintf(
                    '<a href="https://www.php.net/manual/en/datetime.formats.date.php" target="_blank">%s</a>',
    ...
    public function render()
    {
        ...
        if ('custom' === $settings['date_format']) {
            ...
            if ('default' === $time_format) {
                $time_format = \Tools::substr($language->date_format_full, \Tools::strlen($language->date_format_lite));
            }
