...
class ElementColumn extends ElementBase
{
    ...
    protected function _registerControls()
    {
        ...
        $this->addResponsiveControl(
            ...
            [
                ...
                'placeholder' => 20,
                'selectors' => [
                    '{{WRAPPER}} > .elementor-column-wrap > .elementor-widget-wrap > .elementor-widget:not(.elementor-widget__width-auto):not(.elementor-widget__width-initial, .elementor-widget__width-calc):not(:last-child):not(.elementor-absolute)' => 'margin-bottom: {{VALUE}}px', //Need the full path for exclude the inner section
                ],
            ]
        );
    ...
    public function beforeRender()
    {
        ...
        if (($section = Helper::$section_stack[0])->getSettings('tabs') &&
