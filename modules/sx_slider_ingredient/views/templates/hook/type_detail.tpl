{if $ingredientslider.slides}
    <div class="section-body-ingredients">
      ...
      <div class="title-ingredients">
        ...
        <p class="text-center ingredients__text">{l s='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus libero mi, pulvinar dapibus ligula et, pharetra scelerisque diam. ' d='Shop.Theme.Catalog'}</p>
