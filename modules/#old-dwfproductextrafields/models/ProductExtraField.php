...
if ($moduleManager->isInstalled('dwfproductextrafields')) {
    ...
    foreach ($fields as $field) {
        switch ($field->type) {
            case 'color':
            case 'image':
                $content .= "        '".$field->fieldname."' => array('type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isString', 'size' => 255), \n";
                break;
            ...
            case 'text':
                $content .= "        '".$field->fieldname."' => array('type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isString', 'size' => 255), \n";
                break;
