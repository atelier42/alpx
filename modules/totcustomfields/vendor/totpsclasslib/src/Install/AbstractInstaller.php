...
use TotcustomfieldsClasslib\Database\ForeignKey\ForeignKeyHandler;
use TotcustomfieldsClasslib\Database\ObjectModelExtension;
use TotcustomfieldsClasslib\Module\Module;
use TotcustomfieldsClasslib\Registry;
use Db;
use DbQuery;
use Language;
use Tab;
...
abstract class AbstractInstaller
{
    ...
    public function installAdminControllers()
    {
        ...
        foreach ($this->getAdminControllers() as $tabData) {
            ...
            if ($tabData['class_name'] == 'totcustomfields' && version_compare(_PS_VERSION_, '1.7', '<')) {
     ...
     * @return bool
     */
    private function setCheckForeignKey($check)
    {
