...
use TotcustomfieldsClasslib\Install\AbstractInstaller;
use TotcustomfieldsClasslib\Install\ExtensionInstaller;
use Configuration;
use Db;
use DbQuery;
use Hook;
...
{
    const INSTALL_MODULE_TABS_HOOK = 'actionInstallTotcustomfieldsTabs';

    const UNINSTALL_MODULE_TABS_HOOK = 'actionUninstallTotcustomfieldsTabs';
    ...
    {
        $result = parent::installAdminControllers();

        Hook::exec(self::INSTALL_MODULE_TABS_HOOK, [
            'moduleName' => 'totcustomfields',
        ], null, false, false);
    ...
    {
        $result = parent::uninstallModuleAdminControllers();

        Hook::exec(self::UNINSTALL_MODULE_TABS_HOOK, [
            'moduleName' => 'totcustomfields',
        ], null, false, false);
