...
class CustomFieldsInputCheckboxService
{
    /**
     * Returns an existing CustomFieldsInputCheckboxValue from the parameters,
     * or a new object filled with their values if none was found
     *
     * @param int $idInput
     * @param int $idObject
     * @param int|null $idLang if null, return non-translatable value
     *
     * @return CustomFieldsInputCheckboxValue
     *
    ...
    public function getInputValue($idInput, $idObject, $idLang)
    {
        ...
        $query->from('totcustomfields_input_checkbox_value');
        ...
        if ($res) {
            return new CustomFieldsInputCheckboxValue((int) $res);
        }

        $newInputValue = new CustomFieldsInputCheckboxValue();
    ...
    public function getAllInputValues($idInput)
    {
        ...
        $inputValues = [];
        foreach ($res as $row) {
            $inputValues[] = new CustomFieldsInputCheckbox((int) $row['id_input_value']);
        }
