...
class HookAdminCategory extends AbstractHook
{
    /**
    ...
    /**
     * @var ExtensionActionsHandler
     */
    protected static $valuesHandler;
    ...
    public function displayBackOfficeCategory($params)
    {
        return $this->objectsService->displayObjectBackOfficeInputs('category', $params, __FUNCTION__);
    }
}
