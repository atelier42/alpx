...
function upgrade_module_2_1_0($module)
{
    ...
    $moduleInstaller = new \TotcustomfieldsClasslib\Install\ModuleInstaller($module);
    $moduleInstaller->uninstallModuleAdminControllers();
    $moduleInstaller->installAdminControllers();
