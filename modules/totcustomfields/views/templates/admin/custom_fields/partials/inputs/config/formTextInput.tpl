...
<ps-input-text-lang name="type_configuration[{$code_type|escape:'htmlall':'UTF-8'}][default_value]"
    ...
    {foreach from=$languages item=lang}
        <div data-is="ps-input-text-lang-value"
             ...
             value="{if isset($data.currentConf) && isset($data.currentConf.default_value[$lang.id_lang])}{$data.currentConf.default_value[$lang.id_lang]|escape:'htmlall':'UTF-8'}{/if}"
        ></div>
    {/foreach}
</ps-input-text-lang>
...
<ps-input-text name="type_configuration[{$code_type|escape:'htmlall':'UTF-8'}][maxlength]"
               ...
               value="{if isset($data.currentConf)}{$data.currentConf.maxlength|escape:'htmlall':'UTF-8'}{/if}"
