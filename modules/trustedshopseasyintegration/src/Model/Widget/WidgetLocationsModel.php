...
class WidgetLocationsModel implements \JsonSerializable
{
    ...
    /**
     * @param WidgetLocationModel[] $widgetLocations
     *
     * @return WidgetLocationsModel
     */
    public function setWidgetLocations($widgetLocations)
    {
        $this->widgetLocations = $widgetLocations;
