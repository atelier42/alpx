...
class ProductIdentifiersModel implements \JsonSerializable
{
    /**
     * @var ProductIdentifierModel[]
     */
    private $productIdentifiers = [];

    /**
     * @return ProductIdentifierModel[]
     */
    ...
    /**
     * @param ProductIdentifierModel[] $productIdentifiers
     *
