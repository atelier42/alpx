...
class MappedChannelsModel implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * @param array $mappedChannels
     *
     * @return MappedChannelsModel
     */
    public function setMappedChannels($mappedChannels)
    {
