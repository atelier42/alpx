...
namespace TrustedshopsAddon\Model\ProductReview;
...
class ProductReviewModel implements \JsonSerializable
{
     ...
     * @var bool
     */
    private $isProductReviewActivated = false;
     ...
     * @return bool
     */
    public function isProductReviewActivated()
    {
        return $this->isProductReviewActivated;
    }

    /**
     * @param bool $isProductReviewActivated
     *
     * @return ProductReviewModel
     */
    public function setIsProductReviewActivated($isProductReviewActivated)
    {
        $this->isProductReviewActivated = $isProductReviewActivated;
