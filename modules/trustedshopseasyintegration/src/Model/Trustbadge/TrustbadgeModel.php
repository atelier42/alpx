...
class TrustbadgeModel implements \JsonSerializable
{
    /**
     * @var string
     */
    private $idTrustbadge;
     ...
     * @var string|null
     */
    private $trustbadgeConfig = null;

    /**
     * @return string
     */
    public function getIdTrustbadge()
    {
        return $this->idTrustbadge;
    }

    /**
     * @param string $idTrustbadge
     *
     * @return TrustbadgeModel
     */
    public function setIdTrustbadge($idTrustbadge)
    {
        $this->idTrustbadge = $idTrustbadge;
     ...
     * @return string|null
     */
    public function getTrustbadgeConfig()
    {
        return $this->trustbadgeConfig;
    }

    /**
     * @param string|null $trustbadgeConfig
     *
     * @return TrustbadgeModel
     */
    public function setTrustbadgeConfig($trustbadgeConfig)
    {
    ...
    /**
     * @param string|null $salesChannelRef
     *
     * @return TrustbadgeModel
     */
