...
class OrderStatusEventsModel implements JsonSerializable
{
     ...
     * @var bool
     */
    private $isOrderStatusEventsActivated = false;
     ...
     * @return bool
     */
    public function isOrderStatusEventsActivated()
    {
        return $this->isOrderStatusEventsActivated;
    }

    /**
     * @param bool $isOrderStatusEventsActivated
     *
     * @return OrderStatusEventsModel
     */
    public function setIsOrderStatusEventsActivated($isOrderStatusEventsActivated)
    {
        $this->isOrderStatusEventsActivated = $isOrderStatusEventsActivated;
