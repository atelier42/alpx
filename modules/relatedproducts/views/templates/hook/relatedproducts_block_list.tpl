                      ...
                      <div class="item clearfix">
                        {if $display_image ==1}
                          ...
                          <div class="rp_content clearfix">
                            ...
                            <p class="{$class_name|escape:'htmlall':'UTF-8'} related_product_desc">
                              {$related_product.products->description_short nofilter} {* HTML Content *}
                            </p>
                            <div class="bottom_block">
                              ...
                              <div class="related_checkbox">
                                <button class="btn btn-info button rp_select_button" onclick="addRelatedProducts('{$related_product.products->price|escape:'htmlall':'UTF-8'}', this, null, {$key})"> {l s='Select Product' mod='relatedproducts'}
