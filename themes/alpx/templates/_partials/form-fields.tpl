...
{else}
  ...
  <div class="form-group row {if !empty($field.errors)}has-error{/if}">
    <label class="{if $page.page_name=='authentication'}col-md-12{else}col-md-3{/if} form-control-label{if $field.required} required{/if}" for="field-{$field.name}">
      {if $field.type !== 'checkbox'}
        {$field.label}
      {/if}
    </label>
    <div class="{if $page.page_name=='authentication'}col-md-12{else}col-md-6{/if}{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
