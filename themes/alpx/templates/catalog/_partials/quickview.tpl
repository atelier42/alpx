  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content">
     ...
     <div class="modal-footer">
         <div class="cta-product" style="display:flex;justify-content:center;text-align: center;">
             <a href="{$product.url}" class="link-product btn btn-primary">
                 {l s='Retour à ce produit'  d='Shop.Theme.Global'}
             </a>
         </div>
